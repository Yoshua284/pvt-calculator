...
# Tukar porsinya: col1 (8) buat judul yang lebar, col2 (1) buat logo di ujung kanan
...
with col2:
    # GANTI LINK DI BAWAH DENGAN LINK LOGO PATRA LU (.png)
    st.image("https://upload.wikimedia.org/wikipedia/id/thumb/9/95/Logo_Institut_Teknologi_Bandung.png/250px-Logo_Institut_Teknologi_Bandung.png", width=100) 
...
<div class="author-card">
    <h4 style="text-align: center; border-bottom: 1px solid rgba(255,255,255,0.3); padding-bottom: 10px;">👨‍💻 Dikembangkan Oleh:</h4>
    <div style="display: flex; justify-content: space-between; margin-top: 15px;">
        <div style="text-align: center; width: 31%;">
            <img src="https://i.ibb.co.com/84zYnXZ1/Untitled-design-5.png" style="width: 100%; border-radius: 8px; margin-bottom: 5px;">
            <p style="color: white; font-size: 11px; margin: 0; line-height: 1.2;">Rifqi<br>12224028</p>
        </div>
        <div style="text-align: center; width: 31%;">
            <img src="https://i.ibb.co.com/HjCwLxh/Untitled-design-4.png" style="width: 100%; border-radius: 8px; margin-bottom: 5px;">
            <p style="color: white; font-size: 11px; margin: 0; line-height: 1.2;">Yoshua<br>12224029</p>
        </div>
        <div style="text-align: center; width: 31%;">
            <img src="https://i.ibb.co.com/zTkdH3FQ/Untitled-design-6.png" style="width: 100%; border-radius: 8px; margin-bottom: 5px;">
            <p style="color: white; font-size: 11px; margin: 0; line-height: 1.2;">Khayru<br>12224046</p>
        </div>
    </div>
</div>
"""
...
# =============================================================================
# AUTO-RUN STREAMLIT (ANTI LOOPING - JALUR AMAN)
# =============================================================================
if __name__ == '__main__':
    import os
    
    # Cek apakah 'gembok' sudah terpasang
    if os.environ.get('IS_STREAMLIT_RUNNING') != 'True':
        # Pasang gembok biar nggak looping
        os.environ['IS_STREAMLIT_RUNNING'] = 'True'
        # Jalanin Streamlit
